...
- 🛠️ MCP support
- #️⃣ Built-in Root Shell tools and remote SSH connection support
- 🔋 Wake lock backed keep-alive during active generation and terminal sessions
- 🗜️ Conversation compression with custom control over how many recent messages to preserve
