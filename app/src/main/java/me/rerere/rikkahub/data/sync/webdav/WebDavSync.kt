                        ...
                        "rikka_hub.db", "rikka_hub-wal", "rikka_hub-shm" -> {
                            ...
                            if (config.items.contains(WebDavConfig.BackupItem.FILES) &&
                                ...
                                if (fileName.isNotEmpty()) {
                                    ...
                                    if (!targetFile.canonicalPath.startsWith(uploadFolder.canonicalPath)) {
                                        Log.e(TAG, "restoreFromBackupFile: Path traversal attempt blocked: ${zipEntry.name}")
                                        throw Exception("Invalid file path: path traversal attempt")
                                    }
