            ...
            Row(
                ...
                Select(
                    ...
                    onOptionSelected = {
                        ...
                        if (constructor != null) {
                            options = constructor.callBy(mapOf())
...
private fun TavilyOptions(
    ...
    FormItem(
        label = {
            Text(stringResource(R.string.setting_search_api_key))
        }
    ) {
        OutlinedTextField(
    ...
    FormItem(
        label = {
            Text(stringResource(R.string.setting_search_depth))
        }
    ) {
...
private fun SearXNGOptions(
    ...
    FormItem(
        label = {
            Text(stringResource(R.string.setting_search_api_url))
        }
    ) {
        OutlinedTextField(
            value = options.url,
    ...
    FormItem(
        label = {
            Text(stringResource(R.string.setting_search_engines))
        }
    ) {
        OutlinedTextField(
    ...
    FormItem(
        label = {
            Text(stringResource(R.string.setting_search_language))
        }
    ) {
        OutlinedTextField(
    ...
    FormItem(
        label = {
            Text(stringResource(R.string.setting_search_username))
        }
    ) {
        OutlinedTextField(
    ...
    FormItem(
        label = {
            Text(stringResource(R.string.setting_search_password))
        }
    ) {
        OutlinedTextField(
...
private fun PerplexityOptions(
    ...
    FormItem(
        label = {
            Text(stringResource(R.string.setting_search_max_tokens))
        }
    ) {
        OutlinedTextField(
    ...
    FormItem(
        label = {
            Text(stringResource(R.string.setting_search_max_tokens_per_page))
        }
    ) {
        OutlinedTextField(
...
private fun JinaOptions(
    ...
    FormItem(
        label = {
            Text(stringResource(R.string.setting_search_search_url))
        }
    ) {
        OutlinedTextField(
            ...
            modifier = Modifier.fillMaxWidth(),
            placeholder = {
                Text(stringResource(R.string.setting_search_search_url_placeholder))
            }
        )
    }
    ...
    FormItem(
        label = {
            Text(stringResource(R.string.setting_search_scrape_url))
        }
    ) {
        OutlinedTextField(
            ...
            modifier = Modifier.fillMaxWidth(),
            placeholder = {
                Text(stringResource(R.string.setting_search_scrape_url_placeholder))
            }
        )
    }
}
...
private fun BochaOptions(
    ...
    FormItem(
        label = {
            Text(stringResource(R.string.setting_search_summary))
        },
        description = {
            Text(stringResource(R.string.setting_search_summary_desc))
        },
        tail = {
            Switch(
...
private fun GrokOptions(
    ...
    FormItem(
        label = {
            Text(stringResource(R.string.setting_search_model))
        }
    ) {
        OutlinedTextField(
            value = options.model,
    ...
    FormItem(
        label = {
            Text(stringResource(R.string.setting_search_custom_url))
        }
    ) {
        OutlinedTextField(
    ...
    FormItem(
        label = {
            Text(stringResource(R.string.setting_search_system_prompt))
        }
    ) {
        OutlinedTextField(
