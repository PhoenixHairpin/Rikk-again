    ...
    override fun compareTo(other: Version): Int {
        ...
        return when {
            ...
            a.prerelease == null && b.prerelease != null -> 1
                ...
                val aPrerelease = a.prerelease
                val bPrerelease = b.prerelease
                if (aPrerelease != null && bPrerelease != null) {
                    comparePrerelease(aPrerelease, bPrerelease)
                } else {
                    0 // This should never happen due to the when branches above
                }
            }
        }
    }
